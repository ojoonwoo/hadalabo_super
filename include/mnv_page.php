...
class mnv_page
{
	...
	function blockList6( $str = "pageRun(")
	{
		...
		{
			$temp = $this->block_start - 1;
			$block_str .= '<li><a href="javascript:' . $str . $temp . ');" class="prev"><span class="for-a11y">이전</span></a></li>';
		}
		...
		if($this->block != $this->block_count && $this->tot_no != 0){
			$temp = $this->block_end + 1;
			// $block_str .= '<li><a href="javascript:' .$str . $temp . ')">></a></li>';
			$block_str .= '<li><a href="javascript:' . $str . $temp . ');" class="next"><span class="for-a11y">다음</span></a></li>';
		}
