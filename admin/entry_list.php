...
?>
              <tr>
                ...
                <td><?php echo $buyer_info[$key]['mb_like']?></td>
                <td><?php echo $buyer_info[$key]['quatrain01']?></td>
                <td><?php echo $buyer_info[$key]['quatrain02']?></td>
                <td><?php echo $buyer_info[$key]['quatrain03']?></td>
                <td><?php echo $buyer_info[$key]['quatrain04']?></td>
                <td><?php echo $buyer_info[$key]['quatrain_name']?></td>
